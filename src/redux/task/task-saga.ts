...
export default function* TaskSaga() {
    yield all([watchGetTask(), watchGetProjects(), watchGetGetProjectById(), watchGetGetOwnersByProjectId(), watchGetPrioritiesByProjectId(), watchGetStatusByProjectId(), watchAddTask(), watchUpdateTask(), watchGetTaskById(), watchDeleteTaskById()]);
}
